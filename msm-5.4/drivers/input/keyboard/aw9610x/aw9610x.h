...
#define AW_SAR_FIFO_MAX			(3)
#define AW_SAR_SLIDE_DETEC_TIME_MAX	(800L)
#define AW9610x_SAR_TIME		(2000)

#define EVENT_MAGIC                             'e'
#define EVENT_MAGIC                             'e'
#define	SINGLE_CLICK                            _IO(EVENT_MAGIC, 1)
#define	DOUBLE_CLICK                            _IO(EVENT_MAGIC, 2)
#define	TREBLE_CLICK                            _IO(EVENT_MAGIC, 3)
#define	LONG_PRESS                              _IO(EVENT_MAGIC, 4)
#define	LONG_PRESS_PLUS                         _IO(EVENT_MAGIC, 5)
#define	LEFT_SILDE                              _IO(EVENT_MAGIC, 6)
#define	LEFT_SILDE_FAST                         _IO(EVENT_MAGIC, 7)
#define	RIGHT_SILDE                             _IO(EVENT_MAGIC, 8)
#define	RIGHT_SILDE_FAST                        _IO(EVENT_MAGIC, 9)
#define	WEAR_ON                                 _IO(EVENT_MAGIC, 10)
#define	T_WEAR_ON                               _IO(EVENT_MAGIC, 11)
#define	WEAR_OFF                                _IO(EVENT_MAGIC, 12)
...
struct aw9610x {
	...
	uint8_t channel_status_last[3];
	uint8_t channel_status_now[3];
	uint32_t click_slide_flag;
	struct aw_touch_info touch_info[AW_SAR_FIFO_MAX];
};
...
{
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel0",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel1",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel2",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel3",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel4",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar0_channel5",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel0",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel1",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel2",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel3",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel4",
	},
	{
		.curr_state = 0,
		.last_state = 0,
		.name = "nubia_sar1_channel5",
	},
};
